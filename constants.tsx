...
export const PROJECTS: Project[] = [
  {
    ...
    images: ['prana.jpg'],
    description: 'PRANA, also known as the force of life is about revitalization of the slum and squatter settlement of Thapathali area in Kathmandu, Nepal. One of the major areas affected by the waste management in Kathmandu are the riverside corridors which directly or indirectly influences the slums and squatter settlements present there. In the shadows of the urban jungle, slums and squatter settlements are growing daily. Living at the margins of the society, their inhabitants are deprived of basic access to health, education and a decent standard of living.\n\nIn Design Studio III of 6th semester, we were asked to redevelop any slum or squatter settlement in the Kathmandu Valley. I and my team choose Thapathali slum area for our project. With the concept of ameliorating and uplifting the settlements and the inhabitants that live there, the settlement focuses on self sustaining principle that works on a circular economy. This not only boosts the economy of the place but also creates job opportunities for the people there, specially the female population.',
    specifications: {
      area: '1,200 sqm',
  ...
  },
  {
    ...
    specifications: {
      ...
      instructor: 'Prof. Ulrike Heine, Prof. Rayshad Dorsey, and Prof. Amy Trick'
    }
  },
  {
