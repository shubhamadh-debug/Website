    ...
    <div className="pt-32 pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-3xl">
          ...
          <form className="space-y-12 mt-20" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="border-b border-neutral-200 pb-2">
              ...
              <textarea rows={4} className="w-full bg-transparent border-none outline-none text-xl font-serif resize-none" placeholder="Tell me about your inquiry"></textarea>
            </div>
          ...
          <div className="mt-32 grid md:grid-cols-3 gap-12 text-sm text-neutral-500">
            ...
            <div>
              <p className="uppercase tracking-widest font-bold text-neutral-900 mb-2">Direct</p>
              <p className="mb-1">adhika4@clemson.edu</p>
              <p>+1 864 722 7272</p>
            </div>
            <div>
              <p className="uppercase tracking-widest font-bold text-neutral-900 mb-2">Network</p>
