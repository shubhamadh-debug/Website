		...
		return (
			<div className='h-screen flex items-center justify-center'>
				<div className='text-center'>
					...
					<Link
						to='/'
						className='mt-4 inline-block text-sm uppercase tracking-widest text-neutral-400 hover:text-neutral-900 transition-colors'
					>
						Back to Home
					</Link>
				</div>
	...
	return (
		<div className='pt-32 pb-20'>
			<div className='max-w-7xl mx-auto px-6'>
				<Link
					to='/'
					className='inline-flex items-center text-xs uppercase tracking-widest text-neutral-400 hover:text-neutral-900 mb-12 transition-colors'
				>
					<svg
					...
					<div className='grid grid-cols-2 gap-x-8 gap-y-6 text-[10px] uppercase tracking-[0.2em] border-t border-neutral-200 pt-8'>
						<div>
							...
							<p className='text-neutral-900 font-semibold'>
								{project.specifications.institution}
							</p>
						</div>
						<div>
							<p className='text-neutral-400 mb-1'>Course</p>
							<p className='text-neutral-900 font-semibold'>
								{project.specifications.course}
							</p>
						</div>
						<div>
							<p className='text-neutral-400 mb-1'>Instructor</p>
							<p className='text-neutral-900 font-semibold'>
								{project.specifications.instructor || 'N/A'}
							</p>
						</div>
						<div>
				...
				<section className='mb-24'>
					<img
						...
						alt={project.title}
						className='w-full aspect-video object-cover bg-neutral-100 shadow-2xl'
					/>
				</section>

				<section
					className={`mb-24 ${
						project.awards ? 'grid md:grid-cols-12 gap-12' : 'max-w-4xl'
					}`}
				>
					<div className={project.awards ? 'md:col-span-8' : ''}>
						<h3 className='text-xs uppercase tracking-widest font-bold mb-6 text-neutral-400'>
						...
						<div className='md:col-span-4 pt-12 md:pt-0'>
							...
							<ul className='space-y-6'>
								{project.awards.map((award, idx) => (
									<li
										key={idx}
										className='text-sm font-medium text-neutral-900 border-l-2 border-neutral-200 pl-4 py-1 italic leading-snug'
									>
										{award}
									</li>
								))}
