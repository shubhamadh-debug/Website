...
const WeddingDayGuest: React.FC = () => {
	...
	return (
		<div className='wi-root'>
			<style>{`
				...
				.wi-schedule-row:last-child { border-bottom: none; padding-bottom: 0; }
				.wi-schedule-time {
					font-family: var(--font-display);
					font-size: 16px;
					font-weight: 600;
			...
			<main className='wi-paper'>
				<Reveal className='wi-section' as='section'>
					<p className='wi-eyebrow'>The Celebration</p>
					<h2 className='wi-heading'>November 25th</h2>
					<p className='wi-subheading'>The Wedding Day</p>
					<p className='wi-body'>
						The day we've been waiting for. Join us as we say &ldquo;I do.&rdquo;
					</p>
				...
				<Reveal className='wi-section' as='section'>
					<p className='wi-eyebrow'>The Venue</p>
					<h2 className='wi-heading'>Lakefront Retreat: The Lucas</h2>
					<p className='wi-body'>
...
export default WeddingDayGuest;
